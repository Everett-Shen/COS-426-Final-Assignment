...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function dl(){return new si({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zo(),fragmentShader:`
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function fl(){return new si({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zo(),fragmentShader:`
...
`].filter(rs).join(`
`)),o=Eo(o),o=Ml(o,t),o=El(o,t),a=Eo(a),a=Ml(a,t),a=El(a,t),o=bl(o),a=bl(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(b=`#version 300 es
